"use strict";
	 ...
	 * @type {Array<{name:String, category:String, [parameters]:Array<{name:String, [type]:String, [initial]:String, [tip]:String, minValue:Number, maxValue:Number, stepValue:Number, [validate]:function(String):Boolean, [noBrackets]:Boolean}>, [tip]:String, show:Array<String>, [return]:String, [block]:Array<String>, [nameRewrite]:Array<{String, String}>, [dummy]:Boolean, [code]:Array<[unindent]:Boolean, [prefix]:String, [noName]:Boolean, [space]:Boolean, [noBrackets]:Boolean, [suffix]:String>}>}
	...
	$_eseecode.instructions.set = [
		...
		{ name: "blank", category: "cursor", show: ["level1","level2"] },
		{ name: "=", category: "value", parameters: [{name: "variable", type: "var", validate: function(variable){ return (variable.match(/^[A-Za-z][A-Za-z_0-9]*$/)); }, noBrackets: true},{name: "value", initial: undefined, type: "var", noBrackets: true}], return: "var", tip: "Assigns a value to a variable", show: ["level3","level4"], inorder: true, code: { space: true, noBrackets: true } },
		{ name: "getArccosine", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], return: "number", tip: "Returns the arccosine", show: ["level3","level4"] },
		{ name: "getArcsine", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], return: "number", tip: "Returns the arcsine", show: ["level3","level4"] },
		{ name: "getArctangent", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], return: "number", tip: "Returns the arctangent", show: ["level3","level4"] },
		...
		{ name: "getLayerVisibility", category: "value", parameters: [{name: "canvasId", initial: undefined, type: "number"}], return: "bool", tip: "Returns if the layer is visible", show: ["level3","level4"] },
		{ name: "getCosine", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], return: "number", tip: "Returns the cosine", show: ["level3","level4"] },
		{ name: "getRandomColor", category: "value", parameters: [], return: "color", tip: "Returns a random color", show: ["level3","level4"] },
		{ name: "getRandomNumber", category: "value", parameters: [{name: "number", initial: 100, type: "number"}], return: "number", tip: "Returns a random number", show: ["level3","level4"] },
		{ name: "getRGB", category: "value", parameters: [{name: "red", initial: 0},{name: "green", initial: 0, type: "number"},{name: "blue", initial: 0}], return: "number", tip: "Returns a color from and RGB definition", show: ["level3","level4"] },
		{ name: "getSine", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], return: "number", tip: "Returns the sine", show: ["level3","level4"] },
		{ name: "getTangent", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], return: "number", tip: "Returns the tangent", show: ["level3","level4"] },
		{ name: "getSquareRoot", category: "value", parameters: [{name: "number", initial: 0, type: "number"}], return: "number", tip: "Returns the square root of the number", show: ["level3","level4"] },
		...
		{ name: "blank", category: "cursor", show: ["level1"] },
		{ name: "use", category: "canvas", parameters: [{name: "id", initial: 1, type: "number"}], return: "text", tip: "Switches the active canvas, returns the name of the new current canvas", show: ["level3","level4"] },
