"use strict";
	...
	$_eseecode.instructions.set = [
		...
		{ name: "blank", category: "guide", show: ["level1","level2"] },
		{ name: "=", category: "value", parameters: [{name: "variable", type: "var", validate: function(variable){ return (variable.match(/^[A-Za-z][A-Za-z_0-9]*$/)); }, noBrackets: true},{name: "value", initial: "", type: "var", noBrackets: true}], type: "var", tip: "Assigns a value to a variable", show: ["level3","level4"], inorder: true, code: { space: true, noBrackets: true } },
