"use strict";
	 ...
	 * @type {Array<{name:String, category:String, [parameters]:Array<{name:String, [type]:String, [initial]:String, [tip]:String, minValue:Number, maxValue:Number, stepValue:Number, [validate]:function(String):Boolean, [noBrackets]:Boolean}>, [tip]:String, show:Array<String>, [type]:String, [block]:Array<String>, [nameRewrite]:Array<{String, String}>, [dummy]:Boolean, [code]:Array<[unindent]:Boolean, [prefix]:String, [noName]:Boolean, [space]:Boolean, [noBrackets]:Boolean, [suffix]:String>}>}
	 * @example { name: "forward", category: "cursor", parameters: [{name: "pixels", type: "number", initial: 100, tip: "How many pixels do you want to move forward?"}], tip: "Moves forward", show: ["level2","level3","level4"] }
	 */
	$_eseecode.instructions.set = [
		...
		{ name: "forward", category: "cursor", parameters: [{name: "pixels", initial: 100, type: "number", tip: "How many pixels do you want to move forward?"}], tip: "Moves forward", show: ["level2","level3","level4"] },
		{ name: "forward", category: "cursor", parameters: [{name: "pixels", initial: 100, type: "number", tip: "How many pixels do you want to move forward?"}], tip: "Moves 100 steps forward", show: ["level1"] },
		{ name: "forward", category: "cursor", parameters: [{name: "pixels", initial: 50, type: "number"}], tip: "Moves 50 steps forward", show: ["level1"] },
		{ name: "forward", category: "cursor", parameters: [{name: "pixels", initial: 25, type: "number"}], tip: "Moves 25 step forward", show: ["level1"] },
		{ name: "arc", category: "cursor", parameters: [{name: "radius", initial: 50, type: "number" }, { name: "degrees", initial: 15 }, { name: "axis", initial: 0 }, { name: "counterclockwise", initial: false }], tip: "Draws an arc", show: ["level3","level4"] },
		{ name: "blank", category: "cursor", show: ["level1"] },
		{ name: "turnLeft", category: "cursor", parameters: [{name: "degrees", initial: 90, type: "number", minValue: -360, maxValue: 360, tip: "How many degrees do you want to turn?"}], tip: "Turns left", show: ["level2","level3","level4"] },
		{ name: "turnLeft", category: "cursor", parameters: [{name: "degrees", initial: 90, type: "number", tip: "How many degrees do you want to turn?"}], tip: "Turns 90 degrees left", show: ["level1"] },
		{ name: "turnLeft", category: "cursor", parameters: [{name: "degrees", initial: 45, type: "number"}], tip: "Turns 45 degrees left", show: ["level1"] },
		{ name: "turnLeft", category: "cursor", parameters: [{name: "degrees", initial: 15, type: "number"}], tip: "Turns 15 degrees left", show: ["level1"] },
		{ name: "blank", category: "cursor", show: ["level1"] },
		{ name: "turnRight", category: "cursor", parameters: [{name: "degrees", initial: 90, type: "number", tip: "How many degrees do you want to turn?", minValue: -360, maxValue: 360}], tip: "Turns right", show: ["level2","level3","level4"] },
		{ name: "turnRight", category: "cursor", parameters: [{name: "degrees", initial: 90, type: "number", tip: "How many degrees do you want to turn?"}], tip: "Turns 90 degrees right", show: ["level1"] },
		{ name: "turnRight", category: "cursor", parameters: [{name: "degrees", initial: 45, type: "number"}], tip: "Turns 45 degrees right", show: ["level1"] },
		{ name: "turnRight", category: "cursor", parameters: [{name: "degrees", initial: 15, type: "number"}], tip: "Turns 15 degrees right", show: ["level1"] },
		...
		{ name: "getArccosine", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], type: "number", tip: "Returns the arccosine", show: ["level3","level4"] },
		{ name: "getArcsine", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], type: "number", tip: "Returns the arcsine", show: ["level3","level4"] },
		{ name: "getArctangent", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], type: "number", tip: "Returns the arctangent", show: ["level3","level4"] },
		{ name: "getLayerHeight", category: "value", parameters: [], type: "number", tip: "Returns the canvas height", show: ["level3","level4"] },
		{ name: "getLayerWidth", category: "value", parameters: [], type: "number", tip: "Returns the canvas width", show: ["level3","level4"] },
		{ name: "getLayerName", category: "value", parameters: [], type: "text", tip: "Returns the current canvas' name", show: ["level3","level4"] },
		{ name: "getLayerVisibility", category: "value", parameters: [{name: "canvasId", initial: undefined, type: "number"}], type: "bool", tip: "Returns if the layer is visible", show: ["level3","level4"] },
		{ name: "getCosine", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], type: "number", tip: "Returns the cosine", show: ["level3","level4"] },
		{ name: "getRandomColor", category: "value", parameters: [], type: "color", tip: "Returns a random color", show: ["level3","level4"] },
		{ name: "getRandomNumber", category: "value", parameters: [{name: "number", initial: 100, type: "number"}], type: "number", tip: "Returns a random number", show: ["level3","level4"] },
		{ name: "getRGB", category: "value", parameters: [{name: "red", initial: 0},{name: "green", initial: 0, type: "number"},{name: "blue", initial: 0}], type: "number", tip: "Returns a color from and RGB definition", show: ["level3","level4"] },
		{ name: "getSine", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], type: "number", tip: "Returns the sine", show: ["level3","level4"] },
		{ name: "getTangent", category: "value", parameters: [{name: "degrees", initial: 90, type: "number"}], type: "number", tip: "Returns the tangent", show: ["level3","level4"] },
		{ name: "getSquareRoot", category: "value", parameters: [{name: "number", initial: 0, type: "number"}], type: "number", tip: "Returns the square root of the number", show: ["level3","level4"] },
		{ name: "getAngle", category: "value", parameters: [{name: "id", type: "number"}], type: "number", tip: "Returns the current angle", show: ["level3","level4"] },
		{ name: "getX", category: "value", parameters: [{name: "id", type: "number"}], type: "number", tip: "Returns the X coordinate", show: ["level3","level4"] },
		{ name: "getY", category: "value", parameters: [{name: "id", type: "number"}], type: "number", tip: "Returns the Y coordinate", show: ["level3","level4"] },
		...
		{ name: "setColor", category: "cursor", parameters: [{name: "color", initial: "\"#FF0000\"", type: "color", tip: "Which color do you want to use?"}], tip: "Sets the drawing color", show: ["level2","level3","level4"] },
		{ name: "unsetColor", category: "cursor", parameters: [], tip: "Resets the drawing color", show: ["level2","level3","level4"] },
		{ name: "blank", category: "cursor", show: ["level1","level2"] },
		...
		{ name: "goTo", category: "cursor", parameters: [{name: "posx", initial: 0, type: "number", minValue: 0, maxValue: 400, tip: "Set X coordinate to go to"},{name: "posy", initial: 0, type: "number", minValue: 0, maxValue: 400, tip: "Set Y coordinate to go to"}], tip: "Moves to the specified coordinates in the canvas", show: ["level2","level3","level4"] },
		{ name: "blank", category: "cursor", show: ["level1","level2"] },
		...
		{ name: "image", category: "draw", parameters: [{name: "src", initial: "\"\"", type: "text", tip: "URL of an image"},{name: "posx", initial: 0, type: "number", minValue: 0, maxValue: 400, tip: "X coordinate where the image will be painted"},{name: "posy", initial: 0, type: "number", minValue: 0, maxValue: 400, tip: "Y coordinate where the image will be painted"},{name: "width", type: "number", minValue: 0, tip: "Width to show the image, in pixels" },{name: "height", type: "number", minValue: 0, tip: "Height to show the image, in pixels" }], tip: "Sticks an external image", show: ["level2","level3","level4"] },
		{ name: "lineAt", category: "draw", parameters: [{name: "originx", initial: 0, type: "number", minValue: 0, maxValue: 400, tip: "Where should the line begin? Set the X coordinate"},{name: "originy", initial: 0, type: "number", minValue: 0, maxValue: 400, tip: "Where should the line begin? Set the Y coordinate"},{name: "destinationx", initial: 100, type: "number", minValue: 0, maxValue: 400, tip: "Where should the line end? Set the X coordinate"},{name: "destinationy", initial: 100, type: "number", minValue: 0, maxValue: 400, tip: "Where should the line end? Set the Y coordinate"}], tip: "Draws a line from coordinate position to coordinate position", show: ["level2","level3","level4"] },
		...
		{ name: "setColor", category: "cursor", parameters: [{name: "color", initial: "\"#0000FF\"", type: "color"}], tip: "Sets the drawing color to blue", show: ["level1"] },
		{ name: "setColor", category: "cursor", parameters: [{name: "color", initial: "\"#FFFF00\"", type: "color"}], tip: "Sets the drawing color to yellow", show: ["level1"] },
		{ name: "setColor", category: "cursor", parameters: [{name: "color", initial: "\"#00FFFF\"", type: "color"}], tip: "Sets the drawing color to light blue", show: ["level1"] },
		{ name: "setColor", category: "cursor", parameters: [{name: "color", initial: "\"#FFFFFF\"", type: "color"}], tip: "Sets the drawing color to white", show: ["level1"] },
		{ name: "setColor", category: "cursor", parameters: [{name: "color", initial: "\"#000000\"", type: "color"}], tip: "Sets the drawing color to black", show: ["level1"] },
		{ name: "setColor", category: "cursor", parameters: [{name: "color", initial: "\"#555555\"", type: "color"}], tip: "Sets the drawing color to grey", show: ["level1"] },
		{ name: "setColor", category: "cursor", parameters: [{name: "color", initial: "\"#AAAAAA\"", type: "color"}], tip: "Sets the drawing color to light grey", show: ["level1"] },
		{ name: "blank", category: "cursor", show: ["level1"] },
		{ name: "setSize", category: "cursor", parameters: [{name: "size", initial: 16, type: "number"}], tip: "Sets the drawing size to very thick", show: ["level1"] },
		{ name: "setSize", category: "cursor", parameters: [{name: "size", initial: 9, type: "number"}], tip: "Sets the drawing size to thicker", show: ["level1"]},
		{ name: "setSize", category: "cursor", parameters: [{name: "size", initial: 4, type: "number"}], tip: "Sets the drawing size to thick", show: ["level1"]},
		{ name: "blank", category: "cursor", show: ["level1"] },
		{ name: "unsetColor", category: "cursor", parameters: [], tip: "Resets the drawing color", show: ["level1"] },
		{ name: "unsetSize", category: "cursor", parameters: [], tip: "Unsets the drawing size", show: ["level1"] },
		{ name: "blank", category: "cursor", show: ["level1"]},
		{ name: "setBold", category: "cursor", parameters: [{name: "bool", initial: true, type: "bool", tip: "Do you want the text to be bold?" }], tip: "Sets the bold property for future text", show: ["level2","level3","level4"] },
		{ name: "unsetBold", category: "cursor", parameters: [], tip: "Unsets the bold property for future text", show: ["level2","level3","level4"] },
		{ name: "line", category: "cursor", parameters: [{name: "destinationx", initial: 0, type: "number", tip: "Set X coordinate to go to"},{name: "destinationy", initial: 0, type: "number", tip: "Set Y coordinate to go to"}], tip: "Draws a line from current position to specified coordinates", show: ["level2","level3","level4"] },
		{ name: "blank", category: "cursor", show: ["level2"] },
		{ name: "setFont", category: "cursor", parameters: [{name: "font", initial: "\"Comic Sans MS\"", type: "font", tip: "Which font do you want to use?" }], tip: "Sets the font for future text", show: ["level2","level3","level4"] },
		{ name: "unsetFont", category: "cursor", parameters: [], tip: "Resets the font for future text", show: ["level2","level3","level4"] },
		{ name: "write", category: "cursor", parameters: [{name: "text", initial: "\"Hello!\"", type: "text", tip: "Which text do you want to write?"}], tip: "Draws text", show: ["level2","level3","level4"] },
		{ name: "blank", category: "cursor", show: ["level2"] },
		{ name: "setItalic", category: "cursor", parameters: [{name: "bool", initial: true, type: "bool", tip: "Do you want the text to be italic?" }], tip: "Sets the italic property for future text", show: ["level2","level3","level4"] },
		...
		{ name: "if", category: "flow", parameters: [{name: "condition", initial: true, type: "bool", tip: "When should the code be triggered?"}], tip: "Conditional execution", show: ["level2","level3","level4"], block: ["end"], code: { space: true, suffix: " {" } },
		{ name: "ifelse", category: "flow", parameters: [{name: "condition", initial: true, type: "bool"}], tip: "Conditional execution", show: ["level3"], block: ["else","end"], nameRewrite: { level1: "if", level2: "if", level3: "if", level4: "if" }, code: { space: true, suffix: " {" } },
		{ name: "switch", category: "flow", parameters: [{name: "identifier", initial: true, type: "bool"}], tip: "Value based execution", show: [], block: ["end"], code: { space: true, suffix: " {" } },
		...
		{ name: "writeAt", category: "draw", parameters: [{name: "text", initial: "\"Hello!\"", type: "text", tip: "Which text do you want to write?"},{name: "posx", initial: 0, type: "number", minValue: 0, maxValue: 400, tip: "Where do you want to show it? Set the X coordinate"},{name: "posy", initial: 0, type: "number", minValue: 0, maxValue: 400, tip: "Where do you want to show it? Set the Y coordinate"},{name: "angle", initial: 0, type: "number", minValue: -360, maxValue: 360, tip: "In which angle to write the text?"}], tip: "Draws text at specified coodinates", show: ["level2","level3","level4"] }
	];
