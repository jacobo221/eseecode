"use strict";
	...
	$_eseecode.instructions.set = [
		...
		{ name: "writeAt", category: "draw", parameters: [{name: "text",default: "\"Hello!\"", type: "text", tip: "Which text do you want to write?"},{name: "posx",default: 0, type: "number", minValue: 0, maxValue: 400, tip: "Where do you want to show it? X coordinate"},{name: "posy",default: 0, type: "number", minValue: 0, maxValue: 400, tip: "Where do you want to show it? Y coordinate"},{name: "angle",default: 0, type: "number", minValue: -360, maxValue: 360, tip: "In which angle to write the text?"}], tip: "Draws text at specified coodinates", show: ["level2","level3","level4"] }
	];
