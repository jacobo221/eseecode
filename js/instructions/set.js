"use strict";
	...
	$_eseecode.instructions.set = [
		...
		{ name: "turnLeft", category: "cursor", parameters: [{name: "degrees", initial: 90, type: "number", minValue: -360, maxValue: 360, tip: "How many degrees do you want to turn?"}], tip: "Turns 90 degrees left", show: ["level1"] },
		{ name: "turnLeft", category: "cursor", parameters: [{name: "degrees", initial: 45, type: "number", minValue: -360, maxValue: 360, tip: "How many degrees do you want to turn?"}], tip: "Turns 45 degrees left", show: ["level1"] },
		{ name: "turnLeft", category: "cursor", parameters: [{name: "degrees", initial: 15, type: "number", minValue: -360, maxValue: 360, tip: "How many degrees do you want to turn?"}], tip: "Turns 15 degrees left", show: ["level1"] },
		{ name: "blank", category: "cursor", show: ["level1"] },
		{ name: "turnRight", category: "cursor", parameters: [{name: "degrees", initial: 90, type: "number", minValue: -360, maxValue: 360, tip: "How many degrees do you want to turn?"}], tip: "Turns right", show: ["level2","level3","level4"] },
		{ name: "turnRight", category: "cursor", parameters: [{name: "degrees", initial: 90, type: "number", minValue: -360, maxValue: 360, tip: "How many degrees do you want to turn?"}], tip: "Turns 90 degrees right", show: ["level1"] },
		{ name: "turnRight", category: "cursor", parameters: [{name: "degrees", initial: 45, type: "number", minValue: -360, maxValue: 360, tip: "How many degrees do you want to turn?"}], tip: "Turns 45 degrees right", show: ["level1"] },
		{ name: "turnRight", category: "cursor", parameters: [{name: "degrees", initial: 15, type: "number", minValue: -360, maxValue: 360, tip: "How many degrees do you want to turn?"}], tip: "Turns 15 degrees right", show: ["level1"] },
		{ name: "turnReset", category: "cursor", parameters: [{name: "degrees", initial: 0, type: "number", minValue: -360, maxValue: 360, tip: "Which angle do you want the pointer to face?"}], tip: "Resets the angle to initial rotation", show: ["level3","level4"] },
		{ name: "blank", category: "cursor", show: ["level1","level2"] },
		...
		{ name: "goTo", category: "cursor", parameters: [{name: "posx", initial: 0, type: "number", minValue: "minX", maxValue: "maxX", tip: "Set X coordinate to go to"},{name: "posy", initial: 0, type: "number", minValue: "minY", maxValue: "maxY", tip: "Set Y coordinate to go to"}], tip: "Moves to the specified coordinates in the canvas", show: ["level2","level3","level4"] },
		{ name: "blank", category: "cursor", show: ["level1","level2"] },
		...
		{ name: "image", category: "draw", parameters: [{name: "src", initial: "\"\"", type: "text", tip: "URL of an image"},{name: "posx", initial: 0, type: "number", minValue: "minX", maxValue: "maxX", tip: "X coordinate where the image will be painted"},{name: "posy", initial: 0, type: "number", minValue: "minY", maxValue: "maxY", tip: "Y coordinate where the image will be painted"},{name: "width", type: "number", minValue: 0, tip: "Width to show the image, in pixels" },{name: "height", type: "number", minValue: 0, tip: "Height to show the image, in pixels" }], tip: "Sticks an external image", show: ["level2","level3","level4"] },
		{ name: "lineAt", category: "draw", parameters: [{name: "originx", initial: 0, type: "number", minValue: "minX", maxValue: "maxX", tip: "Where should the line begin? Set the X coordinate"},{name: "originy", initial: 0, type: "number", minValue: "minY", maxValue: "maxY", tip: "Where should the line begin? Set the Y coordinate"},{name: "destinationx", initial: 100, type: "number", minValue: "minX", maxValue: "maxX", tip: "Where should the line end? Set the X coordinate"},{name: "destinationy", initial: 100, type: "number", minValue: "minY", maxValue: "maxY", tip: "Where should the line end? Set the Y coordinate"}], tip: "Draws a line from coordinate position to coordinate position", show: ["level2","level3","level4"] },
		...
		{ name: "writeAt", category: "draw", parameters: [{name: "text", initial: "\"Hello!\"", type: "text", tip: "Which text do you want to write?"},{name: "posx", initial: 0, type: "number", minValue: "minX", maxValue: "maxX", tip: "Where do you want to show it? Set the X coordinate"},{name: "posy", initial: 0, type: "number", minValue: "minY", maxValue: "maxY", tip: "Where do you want to show it? Set the Y coordinate"},{name: "angle", initial: 0, type: "number", minValue: -360, maxValue: 360, tip: "In which angle to write the text?"}], tip: "Draws text at specified coodinates", show: ["level2","level3","level4"] }
	];
