"use strict";
	...
	$_eseecode.instructions.set = [
		{ name: "null", category: "internal", parameters: [{name: "text", type: "string", noBrackets: true}], show: [], code: { noName: true, noBrackets: true } },
		{ name: "nullChild", category: "internal", parameters: [{name: "text", type: "string", noBrackets: true}], show: [], dummy: true, code: { noName: true, noBrackets: true, unindent: true } },
		...
		{ name: "comment", category: "other", parameters: [{name: "comment", type: "string", noBrackets: true}], tip: "Comment text, ignored during execution", show: ["level3","level4"], nameRewrite: { level1: "Comment:", level2: "Comment:", level3: "//", level4: "//" }, code: { space: true, noBrackets: true } },
		{ name: "commentmultiline", category: "other", parameters: [{name: "comment", type: "string", noBrackets: true}], tip: "Comment text, ignored during execution", show: [], block: ["endComment"], nameRewrite: { level1: "Comment:", level2: "Comment:", level3: "/*", level4: "/*" }, code: { space: true, noBrackets: true } },
		{ name: "commentmultilinesingle", category: "other", parameters: [{name: "comment", type: "string", noBrackets: true}], tip: "Comment text, ignored during execution", show: [], nameRewrite: { level1: "Comment:", level2: "Comment:", level3: "/*", level4: "/*" }, code: { space: true, noBrackets: true, suffix: " */" } },
		...
		{ name: "label", category: "flow", parameters: [{name: "identifier", type: "string", validate: function(variable){ return (variable.match(/^[A-Za-z][A-Za-z_0-9]*$/)); }, noBrackets: true}], tip: "Label a spot in the code", show: [], code: { noName: true, suffix: ":" } },
		...
		{ name: "call", category: "flow", parameters: [{name: "identifier", type: "string", validate: function(variable){ return (variable.match(/^[A-Za-z][A-Za-z_0-9]*$/)); }, noBrackets: true},{name: "parameters...", type: "string"}], tip: "Call a custom function", show: ["level3"], nameRewrite: { level1: "", level2: "Comment:", level3: "", level4: "" } },
