"use strict";
	...
	$_eseecode.instructions.set = [
		...
		{ name: "setSize", category: "cursor", parameters: [{name: "size", default: 16, type: "number", minValue: 0, tip: "Which size in pixels do you want to set?"}], tip: "Sets the drawing size", show: ["level2","level3","level4"] },
		{ name: "blank", category: "cursor", show: ["level2"] },
		{ name: "setInvisible", category: "cursor", parameters: [{name: "index", type: "number", default: 0.5, stepValue: 0.05, minValue: 0, maxValue: 1, tip: "From 0 (invisible] to 1 (opaque), how invisible do you want to draw?"}], tip: "Sets the drawing transparency value", show: ["level2","level3","level4"] },
		...
		{ name: "blank", category: "cursor", show: ["level1"] },
		{ name: "setBold", category: "cursor", parameters: [{name: "bool", default: true, type: "bool", tip: "Do you want the text to be bold?" }], tip: "Sets the bold property for future text", show: ["level2","level3","level4"] },
		...
		{ name: "blank", category: "cursor", show: ["level2"] },
		{ name: "setItalic", category: "cursor", parameters: [{name: "bool", default: true, type: "bool", tip: "Do you want the text to be italic?" }], tip: "Sets the italic property for future text", show: ["level2","level3","level4"] },
		...
		{ name: "repeat", category: "flow", parameters: [{name: "number", default: 1, type: "number", minValue: 0, tip: "How many times do you want to run the code?"}], tip: "Repeating loop", show: ["level2","level3","level4"], block: ["end"], code: { space: true, suffix: " {" } },
		...
		{ name: "writeAt", category: "draw", parameters: [{name: "text",default: "\"Hello!\"", type: "text", tip: "Which text do you want to write?"},{name: "posx",default: 0, type: "number", minValue: 0, maxValue: 400, tip: "Where do you want to show it? Set the X coordinate"},{name: "posy",default: 0, type: "number", minValue: 0, maxValue: 400, tip: "Where do you want to show it? Set the Y coordinate"},{name: "angle",default: 0, type: "number", minValue: -360, maxValue: 360, tip: "In which angle to write the text?"}], tip: "Draws text at specified coodinates", show: ["level2","level3","level4"] }
	];
