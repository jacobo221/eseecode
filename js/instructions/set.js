...
$e.instructions.init = () => {
	...
	$e.instructions.set = {
		...
		"object-container": { name: "object-container", category: "other", type: "object", nameRewrite: { name: "{}", reduced: "{}", code: "" }, container: [ { instruction: "object" }, { instruction: "endObject" } ] },
		"object": { name: "object", category: "other", type: "object", nameRewrite: { code: "" }, code: { prefix: "{ " } },
		...
		"commentmultiline-container": { name: "commentmultiline-container", category: "other", tip: "Comment text, ignored during execution", nameRewrite: { name: "Comment", reduced: "/* */", code: "" }, container: [ { instruction: "commentmultiline" }, { instruction: "endComment" } ] },
		"commentmultiline": { name: "commentmultiline", category: "other", parameters: [ { name: "comment", type: "other", noBrackets: true } ], tip: "Comment text, ignored during execution", nameRewrite: { name: "Comment", reduced: "/* */:", code: "/*" }, code: { space: true, noBrackets: true } },
		...
		"setColor": { name: "setColor", category: "guide", parameters: [ { name: "color", initial: "#FF0000", type: "color", tip: "Which color do you want to use?" } ], tip: "Sets the drawing color", show: [ "level2", "level3", "level4" ] },
		"unsetColor": { name: "unsetColor", category: "guide", tip: "Unsets the drawing color", show: [ "level2", "level3", "level4" ] },
		...
		"unsetColor1": { name: "unsetColor", category: "guide", tip: "Unsets the drawing color", show: [ "level1" ] },
		"setColor7": { name: "setColor", category: "guide", parameters: [ { name: "color", initial: "#000000", type: "color", tip: "Which color do you want to use?" } ], tip: "Sets the drawing color to black", show: [ "level1" ] },
		"blank8": { name: "blank", category: "guide", show: [ "level1" ] },
		"setColor1": { name: "setColor", category: "guide", parameters: [ { name: "color", initial: "#FF0000", type: "color", tip: "Which color do you want to use?" } ], tip: "Sets the drawing color to red", show: [ "level1" ] },
		"setColor2": { name: "setColor", category: "guide", parameters: [ { name: "color", initial: "#00FF00", type: "color", tip: "Which color do you want to use?" } ], tip: "Sets the drawing color to green", show: [ "level1" ] },
		"setColor3": { name: "setColor", category: "guide", parameters: [ { name: "color", initial: "#0000FF", type: "color", tip: "Which color do you want to use?" } ], tip: "Sets the drawing color to blue", show: [ "level1" ] },
		"setColor4": { name: "setColor", category: "guide", parameters: [ { name: "color", initial: "#FFFF00", type: "color", tip: "Which color do you want to use?" } ], tip: "Sets the drawing color to yellow", show: [ "level1" ] },
		"setColor5": { name: "setColor", category: "guide", parameters: [ { name: "color", initial: "#00FFFF", type: "color", tip: "Which color do you want to use?" } ], tip: "Sets the drawing color to light blue", show: [ "level1" ] },
		"setColor6": { name: "setColor", category: "guide", parameters: [ { name: "color", initial: "#FFFFFF", type: "color", tip: "Which color do you want to use?" } ], tip: "Sets the drawing color to white", show: [ "level1" ] },
		"setColor9": { name: "setColor", category: "guide", parameters: [ { name: "color", initial: "#AAAAAA", type: "color", tip: "Which color do you want to use?" } ], tip: "Sets the drawing color to light grey", show: [ "level1" ] },
		"setColor8": { name: "setColor", category: "guide", parameters: [ { name: "color", initial: "#555555", type: "color", tip: "Which color do you want to use?" } ], tip: "Sets the drawing color to grey", show: [ "level1" ] },
		...
		"if-container": { name: "if-container", category: "flow", nameRewrite: { name: "if", reduced: "if", code: "" }, code: { space: true }, container: [ { instruction: "if" }, { instruction: "elseIf", optional: true, multiple: true}, { instruction: "else", optional: true }, { instruction: "end" } ], tip: "Conditional execution", show: [ "level2", "level3" ], classes: [ "conditional"] },
		"if": { name: "if", category: "flow", parameters: [ { name: "condition", initial: true, type: "bool", tip: "When should the code be triggered?" } ], tip: "Conditional execution", show: [ "level4" ], code: { space: true, suffix: " {" }, classes: [ "conditional"] },
		"elseIf": { name: "elseIf", category: "flow", parameters: [ { name: "condition", initial: false, type: "bool", tip: "When should the code be triggered?" } ], tip: "Alternative branch to conditional execution", nameRewrite: { name: "else if", reduced: "else if", code: "else if" }, code: { prefix: "} ", space: true, suffix: " {" }, classes: [ "conditional"] },
		"else": { name: "else", category: "flow", tip: "Alternative branch to conditional execution", code: { space: true, prefix: "} ", suffix: " {", noBrackets: true }, classes: [ "conditional" ], reportContainer: true },
		...
		"switch": { name: "switch", category: "flow", parameters: [ { name: "identifier", initial: true, type: "bool", tip: "Where is the value we want to check?" } ], tip: "Value based execution", code: { space: true, suffix: " {" }, classes: [ "conditional"] },
		"case": { name: "case", category: "flow", parameters: [ { name: "value", type: "text" } ], code: { extraIndent: true, space: true, noBrackets: true, suffix: ":" }, classes: [ "conditional"] },
		"default": { name: "default", category: "flow", code: { extraIndent: true, suffix: " :" }, classes: [ "conditional"], reportContainer: true },
		"try-container": { name: "try-container", category: "flow", nameRewrite: { name: "try", reduced: "try", code: "" }, container: [ { instruction: "try" }, { instruction: "catch" }, { instruction: "finally", optional: true }, { instruction: "end" }, ], classes: [ "conditional"] },
		"try": { name: "try", category: "flow", code: { suffix: " {" }, classes: [ "conditional"] },
		"catch": { name: "catch", category: "flow", parameters: [ { name: "identifier", initial: "e", type: "text", tip: "Exception to catch" } ], code: { space: true, prefix: "} ", suffix: " {" }, classes: [ "conditional"] },
		"finally": { name: "finally", category: "flow", code: { space: true, prefix: "} ", suffix: " {" }, classes: [ "conditional"] },
		"with-container": { name: "with-container", category: "flow", code: { space: true }, nameRewrite: { name: "with", reduced: "with", code: "" }, container: [ { instruction: "with" }, { instruction: "end" }, ] },
		"with": { name: "with", category: "flow", parameters: [ { name: "object", initial: [], type: "object" } ], code: { space: true, suffix: " {" } },
		"do-container": { name: "do-container", category: "flow", tip: "Conditional loop", nameRewrite: { name: "do while", reduced: "do while", code: "" }, container: [ { instruction: "do" }, { instruction: "endDo" }, ], classes: [ "loop"] },
		"do": { name: "do", category: "flow", code: { suffix: " {", noBrackets: true }, classes: [ "loop"] },
		"endDo": { name: "endDo", category: "flow", parameters: [ { name: "condition", initial: false, type: "bool" } ], nameRewrite: { name: "while", reduced: "while", code: "while" }, code: { space: true, prefix: "} " }, classes: [ "loop"] },
		"while-container": { name: "while-container", category: "flow", code: { space: true }, nameRewrite: { name: "while", reduced: "while", code: "" }, tip: "Conditional loop", show: [ "level2", "level3" ], container: [ { instruction: "while" }, { instruction: "end" }, ], classes: [ "loop"] },
		"while": { name: "while", category: "flow", parameters: [ { name: "condition", initial: false, type: "bool", tip: "The code will be triggered as long as the following condition remains true" } ], tip: "Conditional loop", show: [ "level4" ], code: { space: true, suffix: " {" }, classes: [ "loop"] },
		"repeat-container": { name: "repeat-container", category: "flow", code: { space: true }, nameRewrite: { name: "repeat", reduced: "repeat", code: "" }, tip: "Repeating loop", show: [ "level2", "level3" ], container: [ { instruction: "repeat" }, { instruction: "end" }, ], classes: [ "loop"] },
		"repeat": { name: "repeat", category: "flow", parameters: [ { name: "number", initial: 1, type: "number", minValue: 0, tip: "How many times do you want to run the code?" } ], tip: "Repeating loop", show: [ "level4" ], code: { space: true, suffix: " {" }, classes: [ "loop"] },
		"fill-container": { name: "fill-container", category: "guide", tip: "Draw a shape", show: [ "level2", "level3", "level4" ], code: { space: true }, nameRewrite: { name: "fill", reduced: "fill", code: "" }, show: [ "level2", "level3" ], container: [ { instruction: "fill" }, { instruction: "end" }, ] },
		"fill": { name: "fill", category: "guide", parameters: [ { name: "fillColor", initial: "#000000", type: "color", tip: "Which fill color do you want to use?" }, { name: "borderColor", initial: "#000000", type: "color", tip: "Which border color do you want to use?" } ], tip: "Draw a shape", show: [ "level4" ], code: { space: true, suffix: " {" } },
		"for-container": { name: "for-container", category: "flow", code: { space: true }, nameRewrite: { name: "for", reduced: "for", code: "" }, container: [ { instruction: "for" }, { instruction: "end" }, ], classes: [ "loop"] },
		"for": { name: "for", category: "flow", parameters: [ { name: "initialization;condition;update", initial: ";false;", type: "text", tip: "For syntax: initialize; condition; increment" } ], code: { space: true, suffix: " {" }, classes: [ "loop"] },
		"forIn-container": { name: "forIn-container", category: "flow", code: { space: true }, nameRewrite: { name: "for in", reduced: "for in", code: "" }, container: [ { instruction: "forIn" }, { instruction: "end" }, ], classes: [ "loop"] },
		"forIn": { name: "forIn", category: "flow", parameters: [ { name: "iteration", initial: "x in []", type: "text", tip: "For...in syntax: variable in sequence" } ], nameRewrite: { name: "for", reduced: "for", code: "for" }, code: { space: true, suffix: " {" }, classes: [ "loop"] },
