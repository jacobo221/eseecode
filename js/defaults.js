"use strict";
	...
	var $_eseecode = {
		...
		coordinates: {
			...
			userSelection: 2,
			predefined: [
				{ name: "Computer console", position: {x: 0, y: 0}, scale: {x: 1, y: 1}, initial: false },
				{ name: "Mathematical simple", position: {x: 0, y: 400}, scale: {x: 1, y: -1 }, initial: false },
				{ name: "Mathematical centered", position: {x: 200, y: 200}, scale: {x: 1, y: -1}, initial: true }
			]
		},
		ui: {
