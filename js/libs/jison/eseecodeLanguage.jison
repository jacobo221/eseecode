...
"/*"(.|\r|\n)*?"*/"                %{
                                        ...
                                        return "COMMENT_MULTILINE"; /* eSeeCode */
                                   %}
"//".*($|\r\n|\r|\n)               %{
                                        if (yytext.match(/\r|\n/)) {
                                            yytext = yytext.slice(0,-1); /* eSeeCode remove newline */
                                            parser.newLine = true;
                                        }
...
"var"                              return "VAR";
"array"                            return "ARRAY"; /* eSeeCode */
"void"                             parser.restricted = false; return "VOID";
"while"                            return "WHILE";
"repeat"                           return "REPEAT"; /* eSeeCode */
"fill"                             return "FILL"; /* eSeeCode */
"with"                             return "WITH";
...
"super"                            return "SUPER";
"and"                              return "AND"; /* eSeeCode */
"or"                               return "OR"; /* eSeeCode */
...
VariableStatement
    ...
    /* eSeeCode */
    | "ARRAY" VariableDeclarationList
        {
            $$ = new VariableDeclarationNode($2, "array", createSourceLocation(null, @1, @2));
        }
    ;
...
IterationStatement
    ...
    | "REPEAT" "(" Expression ")" Statement
        {
            $$ = new RepeatStatementNode($3, $5, createSourceLocation(null, @1, @5));
        }
...
LogicalANDExpression
    : BitwiseORExpression
    | LogicalANDExpressionSymbol /* eSeeCode */
...
LogicalANDExpressionNoIn
    : BitwiseORExpressionNoIn
    | LogicalANDExpressionSymbolNoIn /* eSeeCode */
...
LogicalANDExpressionNoBF
    : BitwiseORExpressionNoBF
    | LogicalANDExpressionSymbolNoBF /* eSeeCode */
...
LogicalORExpression
    : LogicalANDExpression
    | LogicalORExpressionSymbol /* eSeeCode */
    | LogicalORExpressionText /* eSeeCode */
    ;
LogicalORExpressionSymbol /* eSeeCode */
...
LogicalORExpressionNoIn
    : LogicalANDExpressionNoIn
    | LogicalORExpressionSymbolNoIn /* eSeeCode */
    | LogicalORExpressionTextNoIn /* eSeeCode */
    ;
LogicalORExpressionSymbolNoIn /* eSeeCode */
...
LogicalORExpressionNoBF
    : LogicalANDExpressionNoBF
    | LogicalORExpressionSymbolNoBF /* eSeeCode */
    | LogicalORExpressionTextNoBF /* eSeeCode */
    ;
LogicalORExpressionSymbolNoBF /* eSeeCode */
...
function parseNumericLiteral(literal) {
	if (literal.charAt(0) === "0" && Number(literal)%1 === 0) { /* eSeeCode */
...
parser.ast.RepeatStatementNode = RepeatStatementNode; /* eSeeCode */
parser.ast.FillStatementNode = FillStatementNode; /* eSeeCode */
...
parser.ast.CommentNode = CommentNode; /* eSeeCode */
