...
var JSHINT = (function() {
  ...
  // Begin eSeeCode customization
  var arraystatement = stmt("array", function (context) {
    var noin = context & prodParams.noin;
    var tokens, lone, value, id;
  ...
  arraystatement.exps = true;
  // End eSeeCode customization
  ...
  // Begin eSeeCode customization
  blockstmt("fill", function (context) {
    var t = state.tokens.next;
  ...
  blockstmt("repeat", function (context) {
    var t = state.tokens.next;
    state.funct["(breakage)"] += 1;
    state.funct["(loopage)"] += 1;
    increaseComplexityCount();
  ...
  blockstmt("for", function(context) {
    ...
    // Begin eSeeCode customization
    } else if (state.tokens.next.id === "array") {
      advance("array");
      decl = state.tokens.curr.fud(headContext);
      comma = decl.hasComma ? decl : null;
      initializer = decl.hasInitializer ? decl : null;
...
Lexer.prototype = {
  ...
  scanKeyword: function() {
    ...
    var keywords = [
      ...
      "super", "return", "typeof", "delete", "repeat", "fill", // eSeeCode
      "switch", "export", "import", "default", "array", // eSeeCode
