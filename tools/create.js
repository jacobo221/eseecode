"use strict";
	...
	add_translations({
		"es": {
			...
			"List of breakpoints and watches": "Lista de puntos de interrupción y puntos de observación",
		...
		"ca": {
			...
			"List of breakpoints and watches": "Llista de punts d'aturada i punts de vigilància",
	...
	var setupItems = {
		...
		"Application settings": {
			...
			autosave: { title: "Autosave periodicity (in seconds)", type: "number", initial: "60", min: "0", help: "The user code will be internally autosaved with this frequency. Set to 0 to disable.", advanced: true, },
		...
		"Programming environment": {
			...
			breakpoints: { title: "List of breakpoints and watches", type: "text", initial: "", help: "Comma-separated list of breakpoints (line number) and/or watches (break when variable's value changes).<br>Example: index,4,10,question,answer,25", advanced: true, },
		...
		"Whiteboard": {
			...
			guidesize: { title: "Size of the guide", type: "number", initial: "20", min: "0", help: "Size of the guide in pixels (size is used for both width and height)", },
			...
			griddivisions: { title: "Amount of grid lines?", type: "number", initial: "15", min: "0", help: "Set the amount of lines in the grid.", },
			...
			whiteboardresolution: { title: "Resolution", type: "number", initial: 400, min: "0", help: "Resolution in the whiteboard, the number applies to both width and height", advanced: true, },
		},
		"Instructions": {
